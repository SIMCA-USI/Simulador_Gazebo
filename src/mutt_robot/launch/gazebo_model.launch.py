...
def generate_launch_description():
    ...
    robot_name = 'mutt_robot'
    package_name = 'mutt_robot'
    
    # Obtenemos la ruta de instalación del paquete (.../install/mutt_robot/share/mutt_robot)
    pkg_share = get_package_share_directory(package_name)
    
    # Obtenemos la carpeta 'share' general (.../install/mutt_robot/share)
    # Esto permite a Gazebo resolver "package://mutt_robot" correctamente
